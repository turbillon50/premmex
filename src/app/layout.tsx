...
export const metadata: Metadata = {
  ...
  description: 'Gestión de contratos funerarios y cobranza en campo',
...
const registerSW = `(function(){if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('/sw.js').catch(function(){});})}})();`
